            ...
            <div className="flex items-center gap-2 min-w-0">
              ...
              <div className="min-w-0">
                <div className="flex items-center gap-2">
                  <span className="text-xs font-medium text-lol-text">{source.name}</span>
                ...
                <p className="text-[10px] text-lol-muted truncate">{source.detail}</p>
              </div>
            </div>
            <div className="text-right flex-shrink-0 ml-2">
              <p className="text-[10px] text-lol-muted">{source.lastUpdate}</p>
            </div>
          </div>
        ))}
        <div className="mt-3 pt-2 border-t border-lol-gold-dark/30">
          <p className="text-[10px] text-lol-muted text-center">
            Patch <span className="text-lol-gold font-medium">26.9</span> · Season 2 Pandemonium
          </p>
          <p className="text-[10px] text-lol-muted/60 text-center mt-1">
