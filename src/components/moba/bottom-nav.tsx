...
export function BottomNav({ activeTab, onTabChange, onOpenSidebar }: { activeTab: string; onTabChange: (tab: string) => void; onOpenSidebar?: () => void }) {
  return (
    <nav className="lg:hidden fixed bottom-0 left-0 right-0 z-40 border-t border-lol-gold-dark/20 safe-bottom"
          ...
          return (
            <button
              ...
              className={`
                ...
                ${isActive
                  ? 'text-lol-gold'
                  : 'text-lol-dim active:text-lol-muted'
                }
              `}
            >
              <div className="relative">
                ...
                {isActive && (
                  <motion.div
                    ...
                    className="absolute -bottom-1.5 left-1/2 -translate-x-1/2 w-4 h-[2px] rounded-full bg-lol-gold"
