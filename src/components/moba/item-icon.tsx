...
export function ItemIcon({ name }: { name: string }) {
  ...
  if (!url || err) return <div className="w-6 h-6 rounded bg-[#1e2328] flex items-center justify-center text-[10px] text-[#5b5a56] border border-[#785a28]/20 shrink-0">{name[0]}</div>;
